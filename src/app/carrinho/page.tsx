              ...
              {cart.map((prod, key) => (
                <div key={key} className={style.cardProdutos}>
                  <div className={style.atribsProduto}>
                    ...
                    <div className={style.infoCard}>
                      ...
                      <div className={style.precos}>
                        <span className={style.currentPrice}>R$ {prod.current_price}</span>
                        <span className={style.oldPrice}>R$ {prod.old_price}</span>
                      </div>
                  ...
                  <div className={style.botoes}>
                    ...
                    <>
                      <button onClick={() => deleteCart(prod.id)} className={style.botao}>
                        <FiTrash />
                      </button>
                    </>
                  </div>
              ...
              <div className={style.totalEFrete}>
                ...
                <div className={style.frete}>
                  ...
                  <p className={style.msgRodape}>
                    Preço de frete para Salvador, Bahia: R$ {products[0].current_price}
                  </p>
                </div>
              </div>
